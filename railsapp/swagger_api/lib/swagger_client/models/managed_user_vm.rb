...
module SwaggerClient
  ...
  class ManagedUserVM
    ...
    def list_invalid_properties
      ...
      if !@password.nil? && @password.to_s.length > 100
        invalid_properties.push("invalid value for 'password', the character length must be smaller than or equal to 100.")
      end

      if !@password.nil? && @password.to_s.length < 4
        invalid_properties.push("invalid value for 'password', the character length must be great than or equal to 4.")
      end
    ...
    def valid?
      ...
      return false if !@password.nil? && @password.to_s.length > 100
      return false if !@password.nil? && @password.to_s.length < 4
      return true
    end
    ...
    def password=(password)
      ...
      if !password.nil? && password.to_s.length < 4
        fail ArgumentError, "invalid value for 'password', the character length must be great than or equal to 4."
      end
    ...
    def hash
      [activated, authorities, created_by, created_date, email, first_name, id, image_url, lang_key, last_modified_by, last_modified_date, last_name, login, password].hash
    end
