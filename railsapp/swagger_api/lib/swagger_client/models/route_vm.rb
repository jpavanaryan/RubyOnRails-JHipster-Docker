...
module SwaggerClient
  ...
  class RouteVM
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'serviceInstances')
        if (value = attributes[:'serviceInstances']).is_a?(Array)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          service_instances == o.service_instances
    end
    ...
    def hash
      [path, service_id, service_instances].hash
    end
